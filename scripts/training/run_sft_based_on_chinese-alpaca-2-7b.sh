...
pretrained_model="hfl/chinese-alpaca-2-7b"
chinese_tokenizer_path="hfl/chinese-alpaca-2-7b"
dataset_dir="../../training_data"
per_device_train_batch_size=2
per_device_eval_batch_size=1
gradient_accumulation_steps=1
max_seq_length=1024
output_dir="./output_chinese-alpaca-2-7b-lora"
validation_file="../../val_data/val_data.json"
num_gpu_per_node=4
deepspeed_config_file=ds_zero3_no_offload.json

torchrun --nnodes 1 --nproc_per_node ${num_gpu_per_node}  run_clm_sft_with_peft.py \
